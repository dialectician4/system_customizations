...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Edwin Santos"
    user-mail-address "edwin.santos.kov@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/edwinsantos/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/edwinsantos/bin" "/profile/bin" "/Users/edwinsantos/.npm-packages/bin" "/Users/edwinsantos/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
